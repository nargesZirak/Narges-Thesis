...
public void handleMessage(EBMessage message) {
   if(seenWarning)
      return;
   seenWarning = true;
   !\colorbox{green}{Log.log(Log.WARNING, this, getClassName() + " should extend EditPlugin not EBPlugin}!  !\colorbox{green}{since it has an empty " + handleMessage());}!
}
\end{lstlisting}
...
public void actionPerformed(ActionEvent evt) {
   ...
   if(action == null) {
      !\colorbox{green}{Log.log(Log.WARNING, this, "Unknown action: " + actionName);}!
   }
   else{
