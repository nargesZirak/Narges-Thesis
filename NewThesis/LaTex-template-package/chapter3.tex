...
There is a problem with higher-order anti-unification in that there is not always a unique MSA defined. \RW{Add an example where this can happen.}  In such cases, we must resort to additional, application-specific information to select amongst the possibilities.
