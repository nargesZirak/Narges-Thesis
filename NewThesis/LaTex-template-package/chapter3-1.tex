...
\begin{figure}[t]
  ...
  \begin{tabular}{clc}
    ...
    \bottomrule
  \end{tabular}
  \caption[Logged methods used as our test suite.]{Logged methods used as our test suite. All are contained in the \protect\code{org.gjt.sp.jedit} package with the exception of Case 9 that is in the \protect\code{org.gjt.sp.jedit.io} package.}
  \label{table:ljms}
\end{figure}
