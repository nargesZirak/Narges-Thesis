...
An empirical study is conducted to evaluate the quality of the anti-unifiers generated by \code{ELUS} in describing the location of log statements in source code. Section~\ref{precision} describes the process of evaluating the precision and recall of \tool{ELUS}.
